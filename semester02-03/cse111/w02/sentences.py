...
def main():
    '''Call the make_sentence function six times to print 
    six randomly generated sentences.'''
    print()
    for i in range(6):
        quantity = random.choice([1, 2])  # Randomly choose between singular and plural
...
def make_sentence(quantity, tense):
    ...
    sentence = f"{determiner.capitalize()} {noun} {verb} {prepositional_phrase_1} {prepositional_phrase_2}."
    return sentence
