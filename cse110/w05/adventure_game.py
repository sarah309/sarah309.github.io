...
if first_choice.lower() == "cabin":
    ...
    if second_choice.lower() == "drive":
        ...
        if third_choice.lower() == "story":
            ...
            print("Offended, Mom refuses to tuck you in and Dad grounds you for two months from electronics. But the next morning, after you tell them the events of the night before, they forgive you and Dad ungrounds you.")
    else:
        invalid = input("Invalid response.")
else:
    invalid = input("Invalid response.")
