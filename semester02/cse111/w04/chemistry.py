...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for compound in symbol_quantity_list:
        ...
        multiplied_mass = atomic_mass * quantity

        # Add the product into the total molar mass.
        total_molar_mass += multiplied_mass
...
def main():
    ...
    #     # Find the data for the elements.
    #     name = periodic_table_dict[element][NAME_INDEX]
    #     atomic_mass = periodic_table_dict[element][ATOMIC_MASS_INDEX]

    #     # Print the element name and atomic mass in the periodic table list.
